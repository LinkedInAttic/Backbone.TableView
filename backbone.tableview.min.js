...
b);b=!0;h=this.data;for(e in h)c=h[e],b?(b=!1,g="?"):g="&",f=f+g+e+"="+c;this.router.navigate(f,{replace:a})}return this};a.prototype.update=function(a,b){this.$("tbody").removeClass("in");this.trigger("updating");this.updateUrl(a);b?this.renderData():this.collection.fetch({data:("function"===typeof this.filterData?this.filterData(_.clone(this.data)):void 0)||this.data});return this};a.prototype.refreshPagination=function(){var a,b,e,g,f,c;a=(this.data.page-1)*this.data.size;c=a+this.collection.size();
0<this.collection.size()&&a++;e=null!=this.collection.count?_.result(this.collection,"count"):-1;0>e?(f=b=this.data.page,g=""):(g=Math.ceil(e/this.data.size)||1,b=_.max([1,this.data.page-2-_.max([0,2+this.data.page-g])]),f=_.min([g,this.data.page+2+_.max([0,3-this.data.page])]),g=" of "+e+" entries");var h,j,i;j=_.range(b,f+1);i=[];f=0;for(h=j.length;f<h;f++)b=j[f],i.push({number:b,active:b===this.data.page&&"active"||""});this.$("#pagination-main").html(this.paginationTemplate({from:a,to:c,total:g,
prevDisabled:1===this.data.page?"disabled":"",nextDisabled:c===e?"disabled":"",pages:i}));return this};a.prototype.renderData=function(){var a,b,e,g,c,l,h,j,i,k;a=this.$("tbody");if(0===this.collection.models.length)a.html(this.emptyTemplate({text:this.empty||"No records to show"}));else{a.html("");i=this.collection.models;h=0;for(j=i.length;h<j;h++){g=i[h];l=$("<tr>");k=this.columns;for(c in k)e=k[c],b=$("<td>").addClass(e.className).addClass(e.tdClass),null!=e.draw?b.html(e.draw(g,this)):b.text(g.get(c)||
...
function(a){return a.charAt(0).toUpperCase()+a.substring(1).replace(/_(\w)/g,function(a,d){return" "+d.toUpperCase()})};return a}(Backbone.View);
