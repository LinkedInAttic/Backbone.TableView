...
null!=(h=parseInt(this.data.size)||this.size)?h:10,this.on("updated",this.refreshPagination));this.loading&&(this.listenTo(this.collection,"request",this.showLoading),this.listenTo(this.collection,"sync",this.hideLoading));this.listenTo(this.collection,"sync",this.renderData);return this};a.prototype.prettyName=function(a){return a.charAt(0).toUpperCase()+a.substring(1).replace(/_(\w)/g,function(a,f){return" "+f.toUpperCase()})};a.prototype.parseQueryString=function(a){var b,d,c,h;c={};if(a&&0<=(b=
