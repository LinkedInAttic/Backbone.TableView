...
a.prototype.events={"keypress .search-query":"updateSearchOnEnter","click    .pager-prev":"prevPage","click    .pager-next":"nextPage","click    th":"toggleSort"};a.prototype.initialize=function(){var a,b,c;this.collection.on("reset",this.renderData);c=this.options;for(a in c)b=c[a],this[a]=b||this[a];this.data=this.initialData||{};this.data.page=this.page||1;this.data.size=this.size||10;return this};a.prototype.setData=function(a,b){this.data[a]=b;return this.update()};a.prototype.createFilter=function(a,
b){switch(b.type){case "option":return new ButtonOptionFilter({id:a,init:b.init||"false",filterClass:b.className||"",options:b.options,setData:this.setData});case "button":return new ButtonFilter({id:a,init:b.init||"false",toggle:b.toggle||"true",filterClass:b.className||"",setData:this.setData});case "input":return new InputFilter({id:a,init:b.init||"",className:"input-prepend inline",filterClass:b.className||"",get:b.get||_.identity,setData:this.setData})}b.setData=this.setData;return b};a.prototype.updateSearchOnEnter=
function(a){13===a.keyCode&&((a=a.currentTarget.value)?this.data[this.search.query||"q"]=a:delete this.data[this.search.query||"q"],this.update());return this};a.prototype.update=function(){this.collection.fetch({data:this.data});return this};a.prototype.renderData=function(){$("tbody",this.$el).html(this.dataTemplate({collection:this.collection,columns:this.columns,empty:this.empty||"No records to show"}));return this};a.prototype.prevPage=function(){if(1<this.data.page)return this.data.page-=1,
$(".page",this.$el).html(this.data.page),this.update()};a.prototype.nextPage=function(){if(this.collection.length===this.data.size)return this.data.page+=1,$(".page",this.$el).html(this.data.page),this.update()};a.prototype.toggleSort=function(a){var b;b=a.currentTarget;a=b.className;if(0<=a.indexOf("sorting_desc"))this.data.sort_dir="asc",a="sorting_asc";else if(0<=a.indexOf("sorting")||0<=a.indexOf("sorting_asc"))this.data.sort_dir="desc",a="sorting_desc";else return this;$("th.sorting_desc, th.sorting_asc",
this.$el).removeClass("sorting_desc sorting_asc");$(b,this.$el).addClass(a);this.data.sort_col=b.abbr;return this.update()};a.prototype.applyTemplate=function(a,b){return b&&a({model:b})||""};a.prototype.render=function(){var a,b=this;this.$el.html(this.template({columns:this.columns,empty:this.empty||"",title:this.applyTemplate(this.titleTemplate,this.title),search:this.applyTemplate(this.searchTemplate,this.search),pagination:this.applyTemplate(this.paginationTemplate,this.pagination)}));this.filters=
_.map(this.filters,function(a,c){return b.createFilter(c,a)});a=$(".filters",this.$el);_.each(this.filters,function(b){a.append(b.render().el);return a.append(" ")});return this.update()};return a}(Backbone.View);
...
ButtonOptionFilter=function(c){function a(){this.update=__bind(this.update,this);return a.__super__.constructor.apply(this,arguments)}__extends(a,c);a.prototype.template=_.template('<div class="btn-group" data-toggle="buttons-radio">\n    <% _.each(options, function (el, i) { %>\n        <button class="btn <%= (i == 0 && "active") || "" %>" value="<%= el.value %>"><%= el.name %></button>\n    <% }) %>\n</div>');a.prototype.events={"click .btn":"update"};a.prototype.initialize=function(){var c=this;
a.__super__.initialize.apply(this,arguments);return this.options.options=_.map(this.options.options,function(a){return{name:c.prettyName(a.name||a),value:a.value||a}})};a.prototype.update=function(a){return this.setData(this.id,a.currentTarget.value)};return a}(Filter);
