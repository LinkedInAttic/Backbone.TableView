(function(){var t,u,v,w,x,y,z,c=function(c,a){return function(){return c.apply(a,arguments)}},A={}.hasOwnProperty,g=function(c,a){function f(){this.constructor=c}for(var b in a)A.call(a,b)&&(c[b]=a[b]);f.prototype=a.prototype;c.prototype=new f;c.__super__=a.prototype;return c},r=[].slice;Backbone.TableView=function(e){function a(){this.hideLoading=c(this.hideLoading,this);this.showLoadingNow=c(this.showLoadingNow,this);this.showLoading=c(this.showLoading,this);this.render=c(this.render,this);this.toggleSort=
...
null!=(h=parseInt(this.data.size)||this.size)?h:10,this.on("updated",this.refreshPagination));this.loading&&(this.listenTo(this.collection,"request",this.showLoading),this.on("updated",this.hideLoading));this.listenTo(this.collection,"sync",this.renderData);return this};a.prototype.prettyName=function(a){return a.charAt(0).toUpperCase()+a.substring(1).replace(/_(\w)/g,function(a,f){return" "+f.toUpperCase()})};a.prototype.parseQueryString=function(a){var b,d,c,h;c={};if(a&&0<=(b=a.indexOf("?")))for(a=
a.substring(b+1),h=/([^&=]+)=?([^&]*)/g,b=function(a){return decodeURIComponent(a.replace(/\+/g," "))};d=h.exec(a);)c[b(d[1])]=b(d[2]);return c};a.prototype.applyTemplate=function(a,b,d){null==d&&(d=12);return b&&d&&a({data:this.data,model:b,classSize:"span"+d,self:this})||""};a.prototype.setData=function(){var a,b,d;a=1<=arguments.length?r.call(arguments,0):[];this.pagination&&(this.data.page=1);for(;1<a.length;)b=a[0],d=a[1],a=3<=a.length?r.call(a,2):[],d||!1===d||0===d?this.data[b]=d:delete this.data[b];
return this.update()};a.prototype.createFilter=function(a,b){var d,c,h,e,k,m,l,n,p,q,s;return new this.filterClasses[b.type]({id:a,extraId:b.extraId,name:null!=(d=b.name)?d:this.prettyName(a),off:null!=(e=b.off)?e:"false",on:null!=(k=b.on)?k:"true",filterClass:null!=(m=b.className)?m:"",options:b.options,init:(null!=(s=b.set)?s:_.identity)(null!=(l=null!=(n=this.data[a])?n:b.init)?l:"",null!=(p=null!=(q=this.data[b.extraId])?q:b.extraInit)?p:""),setData:this.setData,get:null!=(c=b.get)?c:_.identity,
getExtraId:null!=(h=b.getExtraId)?h:_.identity})};a.prototype.updateSearch=function(a){return this.setData(this.search.query||"q",a.currentTarget.value)};a.prototype.updateUrl=function(a){var b,d;d=Backbone.history.fragment;0<=(b=d.indexOf("?"))&&(d=d.substring(0,b));(b=$.param(this.data))&&(d+="?"+b);this.router.navigate(d,{replace:a});return this};a.prototype.update=function(a){this.trigger("updating",a);a&&this.skipInitialFetch?this.renderData():this.fetch&&this.collection.fetch({data:("function"===
...
_.result(this.collection,"count"):-1;0>d?(c=1,e=h=this.data.page,l=""):(c=Math.ceil(d/this.data.size)||1,h=_.max([1,this.data.page-2-_.max([0,2+this.data.page-c])]),e=_.min([c,this.data.page+2+_.max([0,3-this.data.page])]),l=" of "+d+" entries");c=function(){var a,f,d,c;d=_.range(h,e+1);c=[];a=0;for(f=d.length;a<f;a++)b=d[a],c.push({value:b,active:b===this.data.page&&"active"||""});return c}.call(this);k=function(){var a,f,d,c;d=[10,20,50,200];c=[];a=0;for(f=d.length;a<f;a++)b=d[a],c.push({value:b,
active:b===this.data.size&&"active"||""});return c}.call(this);this.$("#pagination-main").html(this.paginationTemplate({from:a,to:m,total:l,prevDisabled:1===this.data.page?"disabled":"",nextDisabled:m===d?"disabled":"",pages:c,sizes:k}));return this};a.prototype.renderData=function(){var a,b,d,c,e,g,k,m,l,n,p,q;a=this.$("tbody");if(0===this.collection.models.length)a.html(this.emptyTemplate({text:null!=(b=this.empty)?b:"No records to show"}));else for(a.html(""),l=this.collection.models,k=0,m=l.length;k<
m;k++){c=l[k];g=$("<tr>");n=this.columns;for(e in n)d=n[e],d.noshow||(b=$("<td>").addClass(d.className).addClass(d.tdClass),null!=d.draw?b.html(d.draw(c,this)):b.text(null!=(p=c.get(e))?p:""),g.append(b));a.append(null!=(q="function"===typeof this.rowTransformer?this.rowTransformer(g,c):void 0)?q:g)}this.trigger("updated");return this};a.prototype.changeSize=function(a){return this.setData("size",parseInt(a.currentTarget.childNodes[0].text))};a.prototype.toPage=function(a){return this.setData("page",
...
arguments)}g(a,e);a.prototype.template=_.template('<button type="button" class="filter btn <%= init == on ? "active" : "" %> <%= filterClass %>"><%= name %></button>');a.prototype.events={"click .filter":"update"};a.prototype.initialize=function(){a.__super__.initialize.apply(this,arguments);this.values=[this.options.off,this.options.on];return this.current=this.options.init===this.options.on?1:0};a.prototype.update=function(a){this.$(a.currentTarget).toggleClass("active");this.current=1-this.current;
return this.setData(this.id,this.values[this.current])};return a}(Backbone.TableView.Filter);Backbone.TableView.ButtonGroupFilter=function(e){function a(){this.update=c(this.update,this);return x=a.__super__.constructor.apply(this,arguments)}g(a,e);a.prototype.template=_.template('<% _.each(options, function (el, i) { %>\n    <button type="button" class="btn <%= _.contains(init, el.value) ? "active" : "" %> <%= !_.isUndefined(el.className) ? el.className : "" %>" value="<%= el.value %>"><%= el.name %></button>\n<% }) %>');
