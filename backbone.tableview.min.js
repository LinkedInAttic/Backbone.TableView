...
a.substring(b+1),h=/([^&=]+)=?([^&]*)/g,b=function(a){return decodeURIComponent(a.replace(/\+/g," "))};d=h.exec(a);)c[b(d[1])]=b(d[2]);return c};a.prototype.applyTemplate=function(a,b,d){null==d&&(d=12);return b&&d&&a({data:this.data,model:b,classSize:"span"+d+" col-lg-"+d,self:this})||""};a.prototype.setData=function(){var a,b,d;a=1<=arguments.length?r.call(arguments,0):[];this.pagination&&(this.data.page=1);for(;1<a.length;)b=a[0],d=a[1],a=3<=a.length?r.call(a,2):[],d||!1===d||0===d?this.data[b]=
d:delete this.data[b];return this.update()};a.prototype.createFilter=function(a,b){var d,c,h,e,k,m,l,n,p,q,s;return new this.filterClasses[b.type]({id:a,extraId:b.extraId,name:null!=(d=b.name)?d:this.prettyName(a),off:null!=(e=b.off)?e:"false",on:null!=(k=b.on)?k:"true",filterClass:null!=(m=b.className)?m:"",options:b.options,init:(null!=(s=b.set)?s:_.identity)(null!=(l=null!=(n=this.data[a])?n:b.init)?l:"",null!=(p=null!=(q=this.data[b.extraId])?q:b.extraInit)?p:""),setData:this.setData,get:null!=
(c=b.get)?c:_.identity,getExtraId:null!=(h=b.getExtraId)?h:_.identity})};a.prototype.updateSearch=function(a){return this.setData(this.search.query||"q",a.currentTarget.value)};a.prototype.updateUrl=function(a){var b,d;d=Backbone.history.fragment;0<=(b=d.indexOf("?"))&&(d=d.substring(0,b));(b=$.param(this.data))&&(d+="?"+b);this.router.navigate(d,{replace:a});return this};a.prototype.update=function(a){this.trigger("updating",a);a&&this.skipInitialFetch?this.renderData():this.fetch&&this.collection.fetch({data:("function"===
...
return a}(Backbone.TableView.Filter);Backbone.TableView.DropdownFilter=function(e){function a(){this.update=c(this.update,this);return z=a.__super__.constructor.apply(this,arguments)}g(a,e);a.prototype.template=_.template('<select class="form-control filter <%= filterClass %>">\n    <% _.each(options, function (el, i) { %>\n        <option <%= init == el.value ? "selected=\'selected\'" : "" %> value="<%= el.value %>"><%= el.name %></option>\n    <% }) %>\n</select>');a.prototype.events={"change .filter":"update"};
